        ...
        <table class="table table-striped">
          ...
          <tbody class="product_list">
            ...
            <tr data-id="{{ $item->productSku->id }}">
              ...
              <td>
                <input type="text" class="form-control form-control-sm amount" @if(!$item->productSku->product->on_sale)
                disabled @endif name="amount" value="{{ $item->amount }}">
              </td>
              <td>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9 col-md-7">
                <select class="form-control" name="address">
                  ...
                  <option value="{{ $address->id }}">{{ $address->full_address }} {{ $address->contact_name }}
